...
static const char qt_meta_stringdata_NetworkManager[] = {
    "NetworkManager\0\0dataChanged()\0"
    "requestStarted()\0requestFinished()\0"
    "requestSuccess()\0reply\0"
    "onFinished(QNetworkReply*)\0url\0"
    "makeRequest(QString)\0QString\0data\0"
};
...
int NetworkManager::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: requestStarted(); break;
        case 2: requestFinished(); break;
        case 3: requestSuccess(); break;
        case 4: onFinished((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        case 5: makeRequest((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 6;
    }
...
// SIGNAL 1
void NetworkManager::requestStarted()
{
...
// SIGNAL 3
void NetworkManager::requestSuccess()
{
